...
class ClassMethodTable {
    ...
    public interface SourceCodePosition {
        ...
        /**
         * Признак того, что метод имеет координаты в исходном коде.
         *
         * @return
         */
        boolean hasPosition();
    ...
    public static class DefaultSourceCodePosition implements SourceCodePosition {
        ...
        public DefaultSourceCodePosition(int lineNumber, int order, boolean hasPosition) {
        ...
        public boolean equals(Object o) {
            ...
            if (hasPosition != that.hasPosition) return false;
     ...
     */
    private static final SourceCodePosition NO_POSITION = new DefaultSourceCodePosition(-1, -1, false);
